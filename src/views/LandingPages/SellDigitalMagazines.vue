<template>
    <base-landing-page
      :hero="{
        header: 'Sell Digital Magazines Directly to Your Readers',
      ...
      :benefits="[
        {
          title: 'Save time',
          description: `Why waste time building a site from scratch?
              Focus on writing and creating while we make sure you have the storefront
              you deserve.`,
          image: './img/landing/circular-clock.svg'
        },
        {
          title: 'Save money',
          description: `When you want to sell digital magazines, you'd rather make money than spend
          it... right? We think so too. This is why it's free to open a store on Prev-U.`,
        ...
        },
        {
          ...
          description: `Whether you like it or not, first impressions matter tremendously in business.
           Make the quality of your online store reflect the quality of your writing.`,
      ...
      :informationSections="[
        ...
        {
          title: `Create an eye-catching product page`,
          description: `Whether you are selling a fitness magazine, a tech magazine or a news magazine,
          you need a product page that grabs the reader's attention. Upload a cover image, write
          your a simple summary and there you go! You will have a simple yet efficient product page
          ready to impress your future readers.`,
          image: './img/landing/placeholder.png'
        },
        {
          title: 'Simplify your clients\' checkout experience',
          description: `Your visitors will follow an easy and intuitive checkout flow.
No need to worry about the delivery of your
              digital magazine to your customers. The magazines are <b>instantly sent by email and
      ...
      :faqQuestions="[
        {
          ...
          answer: `Any file type you might want to use for digital magazines are permitted on Prev-U.
          For instance, you can sell these formats : PDF, ePub, MOBI, etc.`
        },
        {
          question: 'What does it cost?',
          answer: `Prev-U's basic account is free to use. It has <b>no setup or monthly fee</b>,
          making it ideal for any writer, amateur or professional.
