<template>
    <base-landing-page
      :hero="{
        header: 'Sell PDFs Online',
        subheader: 'Sell your PDF files on your own clean and professional store.',
      ...
      :benefits="[
        {
          title: 'Save time',
          description: `Let's be real, it takes time to find a profitable niche. Why waste time
              building a site from scratch?
              Focus on creating great content while we make sure you have the storefront
              you deserve.`,
          image: './img/landing/circular-clock.svg'
        },
        {
          title: 'Save money',
          description: `You'd rather make money selling PDF than spend it... right?
        ...
        },
        {
          ...
          especially online.
           Make the quality of your online store reflect the quality of your work.`,
...
Customize the look and feel of your store to make it more consistent with your brand.
        ...
        },
        {
          ...
          description: `Whether you are selling an eBook, a PDF course or a training plan,
          you need a product page that grabs the reader's attention. The good news is that it's
          quite simple with Prev-U. Upload a cover image, write a description, set a price and
        ...
        },
        {
          ...
          description: `Your visitors will follow an easy and intuitive checkout flow.
              ...
              PDF files to your customers. The products are <b>instantly sent by email and
              made available in their buyer dashboard</b>. Making money selling PDFs is that simple.`,
          link: {
      ...
      :faqQuestions="[
        {
          ...
          answer: `Any file type you might want to use for documents are permitted on Prev-U. For
          instance, you can sell your documents in these formats : PDF, ePub, DOCX, etc.`
        },
        {
